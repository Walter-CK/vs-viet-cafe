window.BAKEHOUSE_MENU = {
    ...
    translations: {
        en: {
            "nav.homeAria": "Back to Logan Reserve Bakehouse home",
            "nav.menu": "Menu",
            "nav.about": "About",
            ...
            "hero.title": "Freshly Baked.",
            "hero.titleAccent": "Locally Loved.",
            "hero.copy": "From crispy Vietnamese banh mi to golden pies, pastries, cakes and barista coffee, Logan Reserve Bakehouse is your everyday stop for food made fresh and served with warmth.",
            "hero.menuCta": "Explore Menu",
            "hero.orderCta": "Pre-order",
            "updates.title": "Latest Updates",
            "updates.copy": "Fresh hours, seasonal bakes and shop news from the team.",
            "updates.follow": "Follow us",
            "updates.welcome": "Welcome to Logan Reserve Bakehouse",
            "updates.labour": "Open 6am-6pm on Labour Day.",
            ...
            "menu.copy": "Big flavours deserve their own space. Choose a category to see the full item list, prices and quick order link.",
            "menu.view": "View category",
            "menu.items": "items",
            "about.eyebrow": "About us",
            "about.title": "A neighbourhood bakery with Vietnamese heart.",
            "about.p1": "Logan Reserve Bakehouse is built around the kind of food people come back for: warm bread, flaky pastries, honest pies, crisp salad rolls and banh mi made with fresh herbs and generous fillings.",
            "about.p2": "We are proud to be part of the local rhythm, from early school runs and tradie coffees to weekend family lunches. Step in, say hello and leave with something fresh from the oven.",
            "busy.eyebrow": "Plan your visit",
            "busy.title": "See when the shop is busiest",
            "busy.copy": "Use the live Google listing to check the bakery, popular visit times, reviews and directions before you head over.",
            ...
            "order.copy": "Use this form to prepare a regular pickup order or a larger catering request. Submissions are parked for now until SMS is connected.",
        ...
        vi: {
            ...
            "hero.title": "Banh moi moi ngay.",
            "hero.titleAccent": "Duoc dia phuong yeu thich.",
            "hero.copy": "Tu banh mi Viet Nam gion ngon den pie vang ruom, banh ngot, banh kem va ca phe barista, Logan Reserve Bakehouse la diem dung hang ngay cho mon an tuoi va am ap.",
            ...
            "updates.anzac": "Mo cua 6am-6pm vao Anzac Day.",
            "updates.easter": "Gio mo cua dip Easter.",
            "menu.eyebrow": "Chon danh muc",
            "menu.title": "Xem thuc don Bakehouse",
            "menu.copy": "Moi nhom mon co trang rieng de xem day du mon, gia va nut dat hang nhanh.",
            "menu.view": "Xem danh muc",
            "menu.items": "mon",
            "about.eyebrow": "Ve chung toi",
            "about.title": "Tiem banh dia phuong voi huong vi Viet Nam.",
            "about.p1": "Logan Reserve Bakehouse lam nhung mon an khach hang muon quay lai: banh mi nong, banh pastry gion, pie dam da, salad roll tuoi va banh mi voi rau thom cung nhan day dan.",
            "about.p2": "Chung toi tu hao la mot phan cua nhip song dia phuong, tu ly ca phe sang som den bua trua cuoi tuan cua gia dinh. Ghe vao chao hoi va mang ve mot mon banh moi ra lo.",
            "busy.eyebrow": "Len ke hoach ghe tiem",
            "busy.title": "Xem luc tiem dong khach",
            "busy.copy": "Dung thong tin Google truc tiep de xem tiem banh, thoi diem dong khach, danh gia va chi duong truoc khi den.",
